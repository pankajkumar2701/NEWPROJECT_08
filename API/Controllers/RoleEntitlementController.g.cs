...
using NEWPROJECT_08.Models;
using NEWPROJECT_08.Data;
using NEWPROJECT_08.Filter;
using NEWPROJECT_08.Entities;
using NEWPROJECT_08.Authorization;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.JsonPatch;
using System.Linq.Expressions;

namespace NEWPROJECT_08.Controllers
{
    /// <summary>
    ...
    {
        private readonly NEWPROJECT_08Context _context;
        ...
        public RoleEntitlementController(NEWPROJECT_08Context context)
        {
            _context = context;
        }
