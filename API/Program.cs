...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "NEWPROJECT_08", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<NEWPROJECT_08Context>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "NEWPROJECT_08 API v1");
