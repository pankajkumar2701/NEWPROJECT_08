...
using NEWPROJECT_08.Entities;

namespace NEWPROJECT_08.Data
{
    /// <summary>
    /// Represents the database context for the application.
    /// </summary>
    public class NEWPROJECT_08Context : DbContext
    {
        /// <summary>
        ...
        {
            optionsBuilder.UseSqlServer("Data Source=DESKTOP-GFUVFUP;Initial Catalog=T754323_NEWPROJECT_08;Persist Security Info=True;user id=pankazz;password=123456;Integrated Security=false;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=true;");
        }
